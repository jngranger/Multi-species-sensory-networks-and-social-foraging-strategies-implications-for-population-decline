...
to setup
 ...
 ; ifelse Starting-Density-Always50 = TRUE
  ;[set N-Birds 50]
  ;[
    set N-Birds (N-Species1 + N-Species2 )
...
to make-birds
  ...
  ask bird [
     ;Set the starting location of each bird (centroid set by GUI) to be randomly located within an area of a size that allows for a density of 1bird/m
...
Species1
Species1
"Set Manual" "Black-Browed Albatross" "Wilson's Storm Petrel" "White Chin Petrel" "Wandering Albatross"
0
...
571
S1 DR
word (S1-DR * S1-Body-Length-Meters) \" meters\"
2
1
11
...
word ((S1-DR * S1-Body-Length-Meters) / Denominator-For-Relationship-Between-DR-and-MinSep) \" meters\"
2
1
11
...
569
S2 DD
word (S2-DR * S2-Body-Length-Meters) \" meters\"
2
1
11
...
word ((S2-DR * S2-Body-Length-Meters) / Denominator-For-Relationship-Between-DR-and-MinSep) \" meters\"
2
1
11
...
<experiments>
  <experiment name="Parameterizing_Sensitivity Analysis" repetitions="1" runMetricsEveryStep="false">
    ...
    <enumeratedValueSet variable="Patch-Scaler">
      <value value="6"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="Tick-Scaler">
      <value value="0.6"/>
    </enumeratedValueSet>
